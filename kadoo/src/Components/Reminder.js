        ...
        <Grid container justifyContent='center' alignItems='center'>
          <Stack direction='row' spacing={1}>
            <Chip
              ...
              color={weekDays[0] ? 'primary' : 'default'}
            />
            <Chip
              label='SUN'
              onClick={handleClick(1)}
              color={weekDays[1] ? 'primary' : 'default'}
            />
            <Chip
              label='MON'
              onClick={handleClick(2)}
              color={weekDays[2] ? 'primary' : 'default'}
            />
            <Chip
              label='TUE'
              onClick={handleClick(3)}
              color={weekDays[3] ? 'primary' : 'default'}
            />
            <Chip
              label='WED'
              onClick={handleClick(4)}
              color={weekDays[4] ? 'primary' : 'default'}
            />
            <Chip
              label='THU'
              onClick={handleClick(5)}
              color={weekDays[5] ? 'primary' : 'default'}
            />
            <Chip
              label='FRI'
              onClick={handleClick(6)}
              color={weekDays[6] ? 'primary' : 'default'}
            />
          </Stack>
        </Grid>
        <Grid container justifyContent='center' alignItems='center'>
